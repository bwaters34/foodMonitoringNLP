...
def evaluate_all_files_in_directory(directory_path,
    ...
    for file_path in file_paths:
        html_format, results, predicted_spans, found_solution = read_file(file_path,
                                                                          ...
                                                                          base_accuracy_on_how_many_unique_food_items_detected=base_accuracy_on_how_many_unique_food_items_detected,
                                                                          use_second_column=use_second_column,
                                                                          pos_tags_setting=pos_tags_setting,
                                                                          use_wordnet=use_wordnet,
                                                                          wordnet_setting=wordnet_setting,
                                                                          use_word2vec_model=use_word2vec_model,
                                                                          use_pretrained_Google_embeddings=use_pretrained_Google_embeddings,
                                                                          ...
                                                                          use_span_merging=use_span_merging,
                                                                          use_plurals=use_plurals,
                                                                          use_twitter_dataset=use_twitter_dataset,
